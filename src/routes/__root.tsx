...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      // Web Push on iOS only works once the app is installed to the Home Screen
      // (16.4+), and these are what make that install launch standalone.
      { name: "mobile-web-app-capable", content: "yes" },
      { name: "apple-mobile-web-app-capable", content: "yes" },
      { name: "apple-mobile-web-app-title", content: "CoinWake" },
      { name: "apple-mobile-web-app-status-bar-style", content: "black-translucent" },
      { property: "og:title", content: "CoinWake — Never Miss Your Crypto Target" },
      {
        property: "og:description",
        content:
          "Price alerts, a loud CoinWake, market-cap profit targets and portfolio tracking in one premium dashboard.",
      },
