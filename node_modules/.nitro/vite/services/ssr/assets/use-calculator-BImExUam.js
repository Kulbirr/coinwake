import { A as errorHint, D as useScenarioCalculator, E as useProfitCalculator, O as useServerConfig, T as useMarketCapCalculator, Z as cn, j as errorMessage, m as useStore, w as useCoin } from "./theme-DXxfDXZX.js";
import { r as marketCapFromPrice } from "./app-ui-CHoxgMIo.js";
import { useCallback, useEffect, useMemo, useState } from "react";
import { Fragment, jsx, jsxs } from "react/jsx-runtime";
import { ChevronDown, Sigma } from "lucide-react";
//#region src/components/app/HowCalculated.tsx
/**
...
function HowCalculated({ rows, className }) {
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [/* @__PURE__ */ jsxs("button", {
			...
			children: [
				/* @__PURE__ */ jsx(Sigma, { className: "size-3.5" }),
				"How is this calculated?",
				/* @__PURE__ */ jsx(ChevronDown, { className: cn("ml-auto size-4 transition-transform", open && "rotate-180") })
			]
		}), open && /* @__PURE__ */ jsx("dl", {
			...
			children: rows.map((row) => /* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsx("dt", {
					...
					children: [row.formula, row.result !== void 0 && /* @__PURE__ */ jsxs(Fragment, { children: [" = ", /* @__PURE__ */ jsx("span", {
...
//#endregion
//#region src/lib/use-calculator.ts
...
function useCalculator(initial = {}) {
	...
	const [fields, setFields] = useState(() => makeFields(initial));
	const [scenarioCaps, setScenarioCaps] = useState(() => [...DEFAULT_SCENARIO_CAPS]);
	...
	const cachedCoin = useMemo(() => coins.find((c) => c.id === fields.coinId), [coins, fields.coinId]);
	...
	const selectCoin = useCallback((next) => {
		setFields((f) => ({
			...f,
			coinId: next.id,
			currentPrice: "",
	...
	const addScenario = useCallback((marketCap) => {
	...
	*/
	const removeScenario = useCallback((marketCap) => {
...
//#endregion
export { HowCalculated as n, useCalculator as t };
