import { H as formatNumber, K as formatUsd, L as alertSubject, P as alertConditionLabel, S as useAlertProgress, U as formatPercent, V as formatCompact, W as formatPrice, X as CoinLogo, Y as Button, Z as cn, d as Delta, f as Signed, m as useStore, q as isGain, r as CoinSearchDialog } from "./theme-DXxfDXZX.js";
import { n as useAppUi } from "./app-ui-CHoxgMIo.js";
import { n as Input, t as Label } from "./label-SOE_QdsM.js";
import { n as AlertProgressBar } from "./AlertCard--NYFh12n.js";
...
import { t as PriceValue } from "./PriceValue-DwIw6OrC.js";
import { t as CoinSparkline } from "./Sparkline-DQ-7B6aF.js";
import { useMemo, useState } from "react";
import { Link } from "@tanstack/react-router";
import { Fragment, jsx, jsxs } from "react/jsx-runtime";
import { ArrowRight, Bell, Coins, Info, Plus, Sparkles, TrendingUp, Wallet } from "lucide-react";
//#region src/components/app/QuickCalculator.tsx
/**
		...
		children: [
			...
			/* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsxs("h2", {
					...
					children: [/* @__PURE__ */ jsx(Sparkles, { className: "size-4 text-primary" }), " Quick Profit Calculator"]
				}), /* @__PURE__ */ jsx(Link, {
					to: "/calculator",
				...
				children: [
					/* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsx(Label, {
							...
							children: coin ? /* @__PURE__ */ jsxs(Fragment, { children: [/* @__PURE__ */ jsx(CoinLogo, {
								coin,
								size: 22
							}), /* @__PURE__ */ jsx("span", {
			...
			/* @__PURE__ */ jsxs("div", {
				...
				children: [
					...
					/* @__PURE__ */ jsx("div", {
						...
						].map((cell) => /* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("div", {
					...
					hasResult && /* @__PURE__ */ jsxs("div", {
						...
						children: [
							result?.multiple != null && /* @__PURE__ */ jsxs("span", {
							...
							coin && targetPrice !== void 0 && /* @__PURE__ */ jsxs(Button, {
								size: "sm",
								variant: "outline",
							...
							/* @__PURE__ */ jsx(Button, {
								...
								children: /* @__PURE__ */ jsxs(Link, {
									to: "/calculator",
									children: ["Scenarios ", /* @__PURE__ */ jsx(ArrowRight, { className: "size-3.5" })]
								})
							})
						]
					}),
					(supplyNote ?? costBasisNote) && /* @__PURE__ */ jsxs("p", {
						className: cn("mt-3 flex gap-1.5 text-xs", supplyEstimated ? "text-warn" : "text-muted-foreground"),
						children: [/* @__PURE__ */ jsx(Info, { className: "mt-px size-3.5 shrink-0" }), supplyNote ?? costBasisNote]
					}),
...
function Dashboard() {
	...
	const activeAlerts = useMemo(() => alerts.filter((a) => a.status === "ACTIVE").slice(0, 4), [alerts]);
	const topHoldings = useMemo(() => portfolio.rows.slice().sort((a, b) => b.value - a.value).slice(0, 5), [portfolio.rows]);
	const movers = useMemo(() => coins.slice().sort((a, b) => b.change24h - a.change24h).slice(0, 5), [coins]);
	return /* @__PURE__ */ jsxs(AppShell, {
		...
		actions: /* @__PURE__ */ jsxs(Fragment, { children: [/* @__PURE__ */ jsx(Button, {
			...
			children: /* @__PURE__ */ jsxs(Link, {
				to: "/portfolio",
				children: [/* @__PURE__ */ jsx(Wallet, { className: "size-4" }), " Portfolio"]
			})
		}), /* @__PURE__ */ jsxs(Button, {
			onClick: () => openAlertDialog(),
			children: [/* @__PURE__ */ jsx(Plus, { className: "size-4" }), " New alert"]
		})] }),
		children: [
			/* @__PURE__ */ jsxs("div", {
			...
			/* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsx("div", {
					...
					children: /* @__PURE__ */ jsx(QuickCalculator, {})
					...
					children: [
						/* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsxs("h2", {
								className: "flex items-center gap-2 font-display text-lg font-semibold",
								children: [/* @__PURE__ */ jsx(Bell, { className: "size-4 text-primary" }), "Active Alerts"]
							}), /* @__PURE__ */ jsxs("span", {
						...
						/* @__PURE__ */ jsxs("div", {
							...
							children: [activeAlerts.length === 0 && /* @__PURE__ */ jsx("p", {
								className: "text-sm text-muted-foreground",
								...
								return /* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsxs("div", {
									...
									className: "mt-2",
									children: /* @__PURE__ */ jsx(AlertProgressBar, {
										alert,
						...
						/* @__PURE__ */ jsx(Button, {
							...
							children: /* @__PURE__ */ jsxs(Link, {
								to: "/alerts",
								children: ["Manage alerts ", /* @__PURE__ */ jsx(ArrowRight, { className: "size-4" })]
							})
						})
					]
				})]
			...
			/* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsxs("section", {
					...
					children: [/* @__PURE__ */ jsxs("div", {
						...
						children: [topHoldings.length === 0 && /* @__PURE__ */ jsx("p", {
							className: "text-sm text-muted-foreground",
					...
					children: [/* @__PURE__ */ jsxs("div", {
						...
						className: "mt-4 space-y-1",
						children: movers.map((coin) => /* @__PURE__ */ jsxs(Link, {
							to: "/coin/$coinId",
							params: { coinId: coin.id },
							...
							children: [
								...
								/* @__PURE__ */ jsxs("div", {
									...
									children: [/* @__PURE__ */ jsx(PriceValue, {
										value: coin.price,
										className: "text-sm font-semibold"
									}), /* @__PURE__ */ jsx("div", {
										className: "mt-0.5",
										children: /* @__PURE__ */ jsx(Delta, {
			...
			watchlist.length > 0 && /* @__PURE__ */ jsxs("section", {
