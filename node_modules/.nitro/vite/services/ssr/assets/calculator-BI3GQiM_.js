import { G as formatSupply, H as formatNumber, K as formatUsd, U as formatPercent, V as formatCompact, W as formatPrice, X as CoinLogo, Y as Button, Z as cn, m as useStore, q as isGain, r as CoinSearchDialog } from "./theme-DXxfDXZX.js";
import { n as useAppUi } from "./app-ui-CHoxgMIo.js";
import { n as Input, t as Label } from "./label-SOE_QdsM.js";
import { t as Route } from "./calculator-C_UHmOOA.js";
import { t as Badge } from "./badge-CgxlUbIx.js";
import { t as AppShell } from "./AppShell-B6uWFBnx.js";
import { i as TabsTrigger, r as TabsList, t as Tabs } from "./tabs-COUlkzTL.js";
import { n as HowCalculated, t as useCalculator } from "./use-calculator-BImExUam.js";
import { t as StatCard } from "./StatCard-C9FCMGPh.js";
import { useEffect, useRef, useState } from "react";
import { Fragment, jsx, jsxs } from "react/jsx-runtime";
import { Bell, Calculator, ChevronsUpDown, Info, Loader2, Plus, Trash2, TrendingUp } from "lucide-react";
import { toast } from "sonner";
import { Area, AreaChart, CartesianGrid, ReferenceDot, ResponsiveContainer, Tooltip, XAxis, YAxis } from "recharts";
//#region src/components/app/ScenarioChart.tsx
/**
...
function ScenarioChart({ points, currentMarketCap, currentValue, height = 280 }) {
	if (points.length < 2) return /* @__PURE__ */ jsx("div", {
		style: { height },
		...
		children: /* @__PURE__ */ jsx(ResponsiveContainer, {
			...
			children: /* @__PURE__ */ jsxs(AreaChart, {
				...
				children: [
					...
					showCurrent && /* @__PURE__ */ jsx(ReferenceDot, {
						x: currentMarketCap,
						y: currentValue,
						r: 5,
						fill: "var(--warn)",
...
function CalculatorPage() {
	...
	*/
	...
	return /* @__PURE__ */ jsxs(AppShell, {
		...
		actions: coin && targetPrice !== void 0 && /* @__PURE__ */ jsxs(Button, {
			variant: "outline",
				...
				children: [/* @__PURE__ */ jsxs("section", {
					...
					children: [
						/* @__PURE__ */ jsxs("h2", {
							...
							children: [
								/* @__PURE__ */ jsx(Calculator, { className: "size-4 text-primary" }),
								" Your position",
								pending && /* @__PURE__ */ jsx(Loader2, { className: "size-3.5 animate-spin text-muted-foreground" })
							]
						}),
						/* @__PURE__ */ jsxs("div", {
							...
							children: [
								/* @__PURE__ */ jsxs("div", {
									...
									children: [/* @__PURE__ */ jsx(Label, {
										...
										children: [coin ? /* @__PURE__ */ jsxs(Fragment, { children: [
										...
										}), /* @__PURE__ */ jsx(ChevronsUpDown, { className: "size-4 shrink-0 text-muted-foreground" })]
									})]
								}),
								/* @__PURE__ */ jsxs("div", {
								...
								/* @__PURE__ */ jsxs("div", {
									...
									children: [/* @__PURE__ */ jsx(Tabs, {
										...
										className: "mt-3.5",
										children: fields.mode === "PRICE" ? /* @__PURE__ */ jsxs("div", {
											className: "space-y-1.5",
											children: [
												/* @__PURE__ */ jsx(Label, {
													className: "text-xs text-muted-foreground",
												...
												targetMarketCap !== void 0 && /* @__PURE__ */ jsxs("p", {
											...
											children: [
												...
												/* @__PURE__ */ jsxs("p", {
													...
													children: [
														...
														formatPrice(targetPrice),
														" ",
														coin && /* @__PURE__ */ jsxs(Fragment, { children: ["per ", coin.symbol] })
													]
												})
											]
										})
						...
						/* @__PURE__ */ jsxs("div", {
							...
							children: [
								...
								/* @__PURE__ */ jsxs("p", {
									...
									children: [/* @__PURE__ */ jsx(Info, { className: "mt-px size-3.5 shrink-0" }), supplyNote ?? (supply !== void 0 ? `Using a circulating supply of ${formatSupply(supply)} — the correct denominator for market cap.` : "No circulating supply reported for this coin. Enter one below to work in market caps.")]
								}),
								/* @__PURE__ */ jsxs("div", {
									...
									children: [
										/* @__PURE__ */ jsxs(Label, {
											className: "text-xs text-muted-foreground",
											htmlFor: "calc-supply",
											children: ["Circulating supply ", /* @__PURE__ */ jsx("span", {
						...
						error && /* @__PURE__ */ jsxs("p", {
							...
							children: [error, hint && /* @__PURE__ */ jsx("span", {
					...
					children: [/* @__PURE__ */ jsxs("section", {
							...
							children: [
								/* @__PURE__ */ jsxs("p", {
									...
									children: [
										...
										coin && fields.mode === "MARKET_CAP" && targetMarketCap !== void 0 && /* @__PURE__ */ jsxs(Fragment, { children: [
											" ",
											"at a",
											" ",
											/* @__PURE__ */ jsx("span", {
								...
								costBasisNote && /* @__PURE__ */ jsxs("p", {
									className: "mt-3 flex gap-1.5 text-[11px] text-warn",
									children: [/* @__PURE__ */ jsx(Info, { className: "mt-px size-3.5 shrink-0" }), costBasisNote]
								}),
								/* @__PURE__ */ jsxs("div", {
									...
									children: [
										...
										currentMarketCap !== void 0 && /* @__PURE__ */ jsxs("span", {
											className: "num rounded-full border border-border bg-surface/60 px-2.5 py-1",
											children: ["Current cap ", formatCompact(currentMarketCap)]
										}),
										hasResult && coin && targetPrice !== void 0 && /* @__PURE__ */ jsxs(Button, {
											size: "sm",
											className: "ml-auto",
											onClick: () => openAlertDialog({
												coin,
						...
						children: [
							/* @__PURE__ */ jsxs("h2", {
								className: "flex items-center gap-2 font-display text-lg font-semibold",
								children: [/* @__PURE__ */ jsx(TrendingUp, { className: "size-4 text-profit" }), " Portfolio value vs market cap"]
							}),
							/* @__PURE__ */ jsxs("p", {
							...
							/* @__PURE__ */ jsx("div", {
								className: "mt-4",
								children: /* @__PURE__ */ jsx(ScenarioChart, {
				...
				children: [
					/* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("h2", {
							...
							children: QUICK_CAPS.map((q) => /* @__PURE__ */ jsx(Button, {
								size: "sm",
								variant: "outline",
								className: "num",
					...
					/* @__PURE__ */ jsxs("form", {
						...
						children: [/* @__PURE__ */ jsx(Input, {
							...
							className: "h-10",
							disabled: scenarioFull,
							children: [/* @__PURE__ */ jsx(Plus, { className: "size-4" }), " Add scenario"]
						})]
					}),
					scenarios.length === 0 ? /* @__PURE__ */ jsx("p", {
						...
						children: /* @__PURE__ */ jsxs("table", {
							...
							children: [/* @__PURE__ */ jsx("thead", { children: /* @__PURE__ */ jsxs("tr", {
								...
								children: [
									...
									/* @__PURE__ */ jsx("th", { className: "w-10 py-2" })
								]
							}) }), /* @__PURE__ */ jsx("tbody", { children: scenarios.map((s) => {
								...
								return /* @__PURE__ */ jsxs("tr", {
									...
									children: [
										/* @__PURE__ */ jsxs("td", {
											...
											children: [formatCompact(s.marketCap), reached && /* @__PURE__ */ jsx(Badge, {
												variant: "outline",
