import { C as useChart, m as useStore } from "./theme-DXxfDXZX.js";
import { useMemo } from "react";
import { jsx, jsxs } from "react/jsx-runtime";
//#region src/components/app/Sparkline.tsx
/**
...
function Sparkline({ points, loading = false, width = 96, height = 32, id }) {
	...
	if (!shape) return /* @__PURE__ */ jsx("svg", {
		width,
		height,
...
function CoinSparkline({ coinId, width, height }) {
	...
	const points = useMemo(() => cached ? cached.map((price) => ({
		t: 0,
		price
	})) : data, [cached, data]);
	return /* @__PURE__ */ jsx(Sparkline, {
		points,
